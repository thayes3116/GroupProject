...
function showCity0List() {
    for (var i = 0; i < cities.length; i++) {
        ...
        if (cities[i][attributesChosen[0]][0] >= 3) {
            ...
            var queryURL3 = "https://cors-bcs.herokuapp.com/https://api.openweathermap.org/data/2.5/weather?" +
...
function showCity1List() {
    for (var i = 0; i < cities.length; i++) {
        ...
        if (cities[i][attributesChosen[1]][0] >= 3) {
            ...
            var queryURL4 = "https://cors-bcs.herokuapp.com/https://api.openweathermap.org/data/2.5/weather?" +
                "q=" + cities[i].city + "&units=imperial&appid=" + APIKeyWeather;
...
function showCity2List() {
    for (var i = 0; i < cities.length; i++) {
        if (cities[i][attributesChosen[2]][0] >= 3) {
            ...
            var queryURL5 = "https://cors-bcs.herokuapp.com/https://api.openweathermap.org/data/2.5/weather?" +
                "q=" + cities[i].city + "&units=imperial&appid=" + APIKeyWeather;
